...
const translations: Record<Language, Translations> = {
  EN: {
    ...
    settings: {
      ...
      webrtcFirefoxHowto:
        'Firefox: open about:config and set media.peerconnection.enabled to false (disables WebRTC entirely).',
  ...
  FR: {
    ...
    settings: {
      ...
      webrtcFirefoxHowto:
        'Firefox : ouvrez about:config et passez media.peerconnection.enabled à false (désactive WebRTC).',
